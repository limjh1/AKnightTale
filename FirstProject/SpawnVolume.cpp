...
void ASpawnVolume::SpawnOurActor_Implementation(UClass* ToSpawn, const FVector& Location)
{
	if (ToSpawn)
	{
		...
		if (World)
		{
			...
			AActor* Actor = World->SpawnActor<AActor>(ToSpawn, Location, FRotator(0.f,180.f,0.f), SpawnParams);
...
void ASpawnVolume::RaiseDoorSpawn()
{
	/*bRaiseDoor = AFloorSwitch::boolRaiseDoor();
