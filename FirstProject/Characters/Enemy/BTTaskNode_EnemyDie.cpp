...
UBTTaskNode_EnemyDie::UBTTaskNode_EnemyDie()
{
	NodeName = TEXT("EnemyDie"); // 행동트리에서 볼 수 있는 이름
}

EBTNodeResult::Type UBTTaskNode_EnemyDie::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
